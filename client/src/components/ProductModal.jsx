        ...
        <div className="p-8">
          ...
          {product.createdBy && (
            <div className="flex items-center gap-3 bg-red-50 border border-red-100 rounded-xl p-3 mb-6">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center text-white font-black text-sm flex-shrink-0">
              ...
              <span className="ml-auto text-xs bg-red-100 text-red-600 font-bold px-2 py-1 rounded-full">Seller</span>
            </div>
          )}
